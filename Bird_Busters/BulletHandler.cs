...
namespace Bird_Busters
{
    ...
    internal class BulletHandler
    {
        ...
        private static int reloadTimerMagazin = 3000;
        ...
        public static void Update()
        {
            ...
            else if (Keyboard.GetState().IsKeyDown(Keys.I) && cheatCode.Equals("K"))
            {
                cheatCode = "KI"; // Setze den Cheat-Code auf "KI", wenn die Taste I nach K gedrückt wird
            }
            else if (Keyboard.GetState().IsKeyDown(Keys.L) && cheatCode.Equals("KI"))
            {
                cheatCode = "KIL"; // Setze den Cheat-Code auf "KIL", wenn die Taste L nach KI gedrückt wird
            }
            else if (Keyboard.GetState().IsKeyDown(Keys.L) && cheatCode.Equals("KIL"))
            {
                cheatActivated = true; // Cheat-Code korrekt und aktiviert
                cheatCode = ""; // Cheat-Code zurücksetzen
                Debug.WriteLine("Cheat aktiviert!");
            }
        ...
        *///        }
        ...
        public static bool isCheatActivated()
        {
